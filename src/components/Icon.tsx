...
// Uso: <Icon path={ICON_PATHS.truck} size={22} color="#1CC8C8" />
// Para adicionar um ícone, basta adicionar a string SVG path ao objeto ICON_PATHS.
...
// ── Catálogo de paths — adicione novos ícones aqui ──────────────────────────
